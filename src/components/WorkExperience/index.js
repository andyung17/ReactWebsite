  ...
  return (
    <ServicesContainer id="work-experience">
      ...
      <ServicesWrapper>
        <ServicesCard
          onClick={() => {
            window.location.href = "https://www.ford.ca//";
          }}
        >
      ...
      <ServicesWrapper>
        <ServicesCard
          onClick={() => {
            window.location.href = "https://www.bluwave-ai.com/";
          }}
        >
      ...
      <ServicesWrapper>
        <ServicesCard
          onClick={() => {
            window.location.href = "https://tc.canada.ca/en";
          }}
        >
      ...
      <ServicesWrapper>
        <ServicesCard
          onClick={() => {
            window.location.href = "https://www.arkalumen.com/";
          }}
        >
